...
const ServiceCard = ({ service }) => {
    return (
        <div className="shadow-lg rounded-lg p-6 text-center bg-white transform transition-transform duration-300 hover:scale-105 hover:shadow-2xl">
            ...
            <button className="bg-[#F7A582] text-white px-4 py-2 rounded-full mt-4 transform transition-transform duration-200 hover:bg-[#07332F] hover:scale-105 hover:shadow-lg">
                Book Appointment
            </button>
        </div>
    );
