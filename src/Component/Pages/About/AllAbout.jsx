...
const AllAbout = () => {
    return (
        ...
        <div className=" mb-96 md:mb-0 pl-3 lg:pl-32 pr-3 lg:pr-32">
            ...
            <section className="h-screen flex  gap-12 md:gap-0 flex-col md:flex-row items-center md:justify-between  py-10 space-y-8 md:space-y-0 ">
                ...
                <div className="md:w-1/2 flex justify-end  items-center  w-full">
                    <iframe 
                        width="100%" 
                        height="315" 
